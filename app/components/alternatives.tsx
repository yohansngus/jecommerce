...
export default function Alternative() {
  const categoryStyle =
    "overflow-hidden bg-white mx-2 w-full sm:w-1/1 lg:w-3/4 lg:mx-0 rounded-md shadow-sm border-[0.5px] border-gray-300 flex flex-col items-center justify-center hover:cursor-pointer hover:scale-105 transition-transform duration-300";
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 lg:h-[150px] xl:flex xl:flex-row xl:flex-nowrap gap-2 mx-5 my-5 p-3 bg-gray-200 border-[0.5px] border-gray-300 shadow-sm xl:border-0 xl:shadow-none rounded-md">
